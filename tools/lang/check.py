...
Русские строки живут в коде (XS("...") в main.cpp, таблицы имён в game.cpp), а
...
Строки служебного лога автофарма (farmlog/fprintf) не проверяются: они
намеренно не переводятся — лог разбирают по русским подписям.
"""
