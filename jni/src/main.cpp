...
int main(int argc, char* argv[]) {
    ...
    while (main_thread_flag) {
        ...
        // Forward the GUI toggle to the reader: bones are only read while the
        // user actually wants the skeleton drawn (saves syscalls otherwise).
        esp_set_skeleton_enabled(g_state.esp_skeleton && g_state.esp_master);
