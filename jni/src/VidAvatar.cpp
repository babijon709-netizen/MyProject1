...
// tools/video/gen_avatar.py из mp4; сейчас 176x176, 12 кадров/с — кружок в
// меню 175.5 px, то есть кадр показывается в натуральную величину). Формат
...
// ~0.3 мс на кадр 176x176 (замер на x86; на телефоне ожидаемо в разы больше,
...
void upload() {
    if (!g_tex) {
        ...
        // Ширина кадра 176x3 = 528 байт — кратно 4, поэтому выравнивание строк
