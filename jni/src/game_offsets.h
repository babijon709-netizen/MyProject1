...
// Verified against the supplied ARM64 binaries:
//   libil2cpp.so build-id 2551c698b8b8923d4f40ca9fc7b70bd659dcdda2
//   libunity.so   build-id 87322e9da224229e
// Keep this manifest in sync when either binary changes.
...
inline constexpr std::uint64_t GAME_OBJECT_COMPONENT_COUNT = 0x30;
inline constexpr std::uint64_t NATIVE_TYPE_ID            = 0x30;
inline constexpr std::uint64_t NATIVE_TYPE_ID_RANGE      = 0x34;
...
// Il2CppClass* TypeInfo globals in libil2cpp.so. The corresponding GOT
// relocations are 0xD17B928 -> 0xD48CFB0 and 0xD1690C8 -> 0xD4884E8.
inline constexpr std::uint64_t IL2CPP_CLASS_STATIC_FIELDS         = 0xB8;
