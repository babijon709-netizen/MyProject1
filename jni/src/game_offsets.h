...
inline constexpr std::uint64_t PLAYER_MANAGER_STATIC_FIELDS_LIST = 0x08;       // activePlayerList at 0x8
...
inline constexpr std::uint64_t PLAYER_POSITION  = 0x1D0; // lastSavedPosition (UnityEngine.Vector3)
