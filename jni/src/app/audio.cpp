// app/audio.cpp — звуки меню (OpenSLES). Разрезано из jni/src/main.cpp.
//
// Сэмплы вшиты в media/audio.h (click_wav/success_wav). Если заголовка нет,
// ветка #else ниже оставляет вызовы пустышками — так модуль собирается и без
// сэмплов (и на хостовой проверке синтаксиса).
