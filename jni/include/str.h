#pragma once
// Шифрование строк интерфейса в бинарнике (XOR по позиции, ключ-генератор
// от смещения). Блок вынесен из main.cpp: строки через XS() используют и
// конфиг, и автофарм, и меню, и тосты.
