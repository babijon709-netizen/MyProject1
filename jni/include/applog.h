...
// пишутся в /sdcard/Download/xvcen.log, чтобы лог можно было забрать из
// «Загрузок» без root и adb. Туда же зеркалируется лог драйвера
// /data/local/tmp/ftdrv.log (сам файл в /data без root не читается).
namespace applog {

// Открывает лог-файл: /sdcard/Download/xvcen.log, при неудаче
// /storage/emulated/0/Download/xvcen.log, затем /data/local/tmp/xvcen.log.
