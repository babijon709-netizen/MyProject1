...
// Кадры аватарки: 253 JPEG 128x128, 12 кадр/с, 404573 Б на всё видео (ролик НЕ вшит целиком, см. tools/video/gen_avatar.py).
static const int vid_avatar_w = 128;
static const int vid_avatar_h = 128;
static const int vid_avatar_fps = 12;
static const int vid_avatar_count = 253;
static const unsigned int vid_avatar_bytes = 404573;
extern const unsigned int vid_avatar_frames;
extern const unsigned int vid_avatar_off[254];
extern const unsigned char vid_avatar_data[404573];
